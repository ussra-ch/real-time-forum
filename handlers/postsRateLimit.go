...
func CheckRateLimitPost(ratelimit *RateLimit, window time.Duration) bool {
...
func UserInfosPosts(r *http.Request) (*RateLimit, bool) {
	rateLimit := &RateLimit{
		count:        0,
		FirstTime:    time.Now(),
		BlockedUntil: time.Time{},
...
func AddUserToTheMap_Post(ratelimit *RateLimit) {
